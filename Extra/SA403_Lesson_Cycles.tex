...
\section*{Goals}
\begin{itemize}
\item Why are cycles such an issue?
\end{itemize}
...
Can we talk about the node-capacitated maximum flow problem here? This would be a nice way to introduce my research to this class!

\section{Try it on your own}

How would you go about finding a cycle?
